...
def main_menu():
  ...
  while run:
    WIN.blit(BG, (0,0))
    title_label = title_font.render('Press the to begin...', 1, (255,255,255))
    subtitle_label = sub_font.render('a = LEFT  d = RIGHT \n  w = UP  s = DOWN \n Space = Shoot', 1, (255,255,255))
    hint_label = hint_font.render('Hint: Enemies that reach the end of the screen substract 1 Life', 1, (255,255,255))
    WIN.blit(title_label, (WIDTH/2 - title_label.get_width()/2, 350))
    WIN.blit(subtitle_label, (WIDTH/2 - subtitle_label.get_width()/2, 450))
    WIN.blit(hint_label, (WIDTH/2 - hint_label.get_width()/2, 500))
    pygame.display.update()
    for event in pygame.event.get():
      if event.type == pygame.QUIT:
        run = False
